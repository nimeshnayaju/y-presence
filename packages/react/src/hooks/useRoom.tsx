import { Awareness, Presence, Room } from '@y-presence/client'
...
function createRoomContext<T extends Presence>() {
  return React.createContext<Room<T> | null>(null)
}

const RoomContext = createRoomContext<any>()

export function RoomProvider<T extends Presence>({
  awareness,
  initialPresence,
  children,
}: RoomProviderProps<T>) {
...
export function useRoom<T extends Presence>() {
